...
You are free to use your preferred text editor to author content. The only requirements for Jekyll to properly render your documentation is to include the appropriate Frontmatter (see below) and that your text is formatted in Markdown / Kramdown. 
## Where to save pages
